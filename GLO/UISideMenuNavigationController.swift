...
//
//  Altered by Stephen Looney to automatically init the tableview when the sidemenu is initialized.
//
...
public class UISideMenuNavigationController: UINavigationController, UITableViewDataSource, UITableViewDelegate {
    
    internal var originalMenuBackgroundColor: UIColor?
    
    // Configure Table Menu Options
    ...
    override public func viewDidLoad() {
        ...
        // Init the menu Table View
        let menuTable = UITableView.init(frame: self.view.frame)
